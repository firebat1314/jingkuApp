...
*/
@IonicPage({
	segment: 'brand-list-cut/:listId/:keyword/:brandId/:supplierId/:type/:cut'
})
@Component({
	selector: 'page-brand-list-cut',
	templateUrl: 'brand-list.html',
})
export class BrandListCutPage {
	goodsList: any;
	timer: any;
